...
`coloquios.db` es una base SQLite diseñada para centralizar dos históricos diferentes:
...
Esta es una práctica de consulta, no una relación física persistida dentro de `coloquios.db`. Cada base puede evolucionar por separado y combinarse cuando una necesidad concreta lo requiere.
